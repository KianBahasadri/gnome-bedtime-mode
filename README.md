...
[latest]: https://github.com/ionutbortis/gnome-bedtime-mode/releases/download/v24.0/gnome-bedtime-mode_24.0.zip

You can download the [latest release package][latest] and manually install it to your extensions folder. The latest package only supports Gnome version '50'!

For older Gnome versions please use the official [GNOME Shell Extensions website][ego] mentioned above.

```
wget https://github.com/ionutbortis/gnome-bedtime-mode/releases/download/v24.0/gnome-bedtime-mode_24.0.zip
# (Or manually download via browser and run the next commands from the download folder)

gnome-extensions install --force gnome-bedtime-mode_24.0.zip

rm gnome-bedtime-mode_24.0.zip
```
